...
#ifndef ESP01_HANDLER_H
#define ESP01_HANDLER_H
 ...
 * Si la red WIFI no esta disponible se conecta a esta IP:PORT automáticamante
...
/**
 * @brief ESP01_START_TCP Configura y Conecta TCP
 *
 ...
 *
 * @retVal Devuelve ESP01_WIFI_GOT_IP, Cuando no tiene IP
 */
...
/**
 * @brief ESP01_WRITE_RX Escribe en el buffer de recepción
 *
