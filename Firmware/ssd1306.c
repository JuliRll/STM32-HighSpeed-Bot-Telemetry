 ...
 */
static uint8_t SSD1306_WriteCommand_DMA(uint8_t command){
    return HAL_I2C_Mem_Write_DMA(&hi2c2, SSD1306_I2C_ADDR, 0x00, 1, &command, 1);
}
...
uint8_t SSD1306_UpdateScreen(void) {
	...
	switch (updateScreenState) {
		case 0:
			SSD1306_WriteCommand_DMA(0xB0 + repetition);
			break;
		case 1:
		...
		case 2:
			...
			break;
		case 3:
			HAL_I2C_Mem_Write_DMA(&hi2c2, SSD1306_I2C_ADDR, 0x40, 1, &SSD1306_Buffer[SSD1306_WIDTH * repetition], SSD1306_WIDTH);
			break;
	}
